...
$contact_us_text_2 = get_field( 'contact_us_text_2', 'options' );
$contact_us_number_3 = get_field( 'contact_us_number_3', 'options' );
$contact_us_text_3 = get_field( 'contact_us_text_3', 'options' );
                        ...
                        <?php if ( !empty( $contact_us_number_2 ) ): ?>
                            <div class="footer-contact">
                                <a class="footer-contact-link" href="tel:<?php echo $contact_us_number_2; ?>">
                                    ...
                                    <?php echo $contact_us_number_2; ?> <?php if ( !empty($contact_us_text_2) ) { echo $contact_us_text_2; } ?>
                                </a>
                            </div>
                        <?php endif; ?>
                        <?php if ( !empty( $contact_us_number_3 ) ): ?>
                            <div class="footer-contact">
                                <a class="footer-contact-link" href="tel:<?php echo $contact_us_number_3; ?>">
                                    ...
                                    <?php echo $contact_us_number_3; ?> <?php if ( !empty($contact_us_text_3) ) { echo $contact_us_text_3; } ?>
                                </a>
                            </div>
                        <?php endif; ?>
